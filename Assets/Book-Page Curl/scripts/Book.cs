...
public class Book : MonoBehaviour {
    ...
    public GameObject rightFlipPoint;
    public GameObject leftFlipPoint;
    ...
    public void UpdateBook()
    {
        ...
        {
            f = Vector3.Lerp(f, rightFlipPoint.transform.localPosition, Time.deltaTime * 10);
            UpdateBookRTLToPoint(f);
        }
        else
        {
            f = Vector3.Lerp(f, leftFlipPoint.transform.localPosition, Time.deltaTime * 10);
    ...
    {
        if (interactable)
        DragRightPageToPoint(rightFlipPoint.transform.localPosition);
    ...
    {
        if (interactable)
        DragLeftPageToPoint(leftFlipPoint.transform.localPosition);
